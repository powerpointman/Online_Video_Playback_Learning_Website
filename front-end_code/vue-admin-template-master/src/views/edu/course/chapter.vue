<template>
  ...
  <div class="app-container">
    ...
    <h2 style="text-align: center;">Post a new course</h2>

    <el-steps :active="2" process-status="wait" align-center style="margin-bottom: 40px;">
      <el-step title="Fill in the basic course information"/>
      <el-step title="Creating a course outline"/>
...
<el-button type="text" @click="openChapterDialog()">Add chapter</el-button>
    ...
    <ul class="chanpterList">
        <li
            ...
            <p>
                ...
                <span class="acts">
                    <el-button style="" type="text" @click="openVideo(chapter.id)">Add a short summary</el-button>
    ...
    <el-dialog :visible.sync="dialogChapterFormVisible" title="Add Chapter">
        ...
        <div slot="footer" class="dialog-footer">
            <el-button @click="dialogChapterFormVisible = false">No</el-button>
            <el-button type="primary" @click="saveOrUpdate">Yes</el-button>
        </div>
    </el-dialog>

    <!-- 添加和修改课时表单 -->
<el-dialog :visible.sync="dialogVideoFormVisible" title="Add class time">
    ...
    <el-form-item label="Upload video">
     <el-upload
        ...
        <el-tooltip placement="right-end">
            <div slot="content">Support 1G，<br>
                Support 3GP、ASF、AVI、DAT、DV、FLV、F4V、<br>
                GIF、M2T、M4V、MJ2、MJPEG、MKV、MOV、MP4、<br>
                MPE、MPG、MPEG、MTS、OGG、QT、RM、RMVB、<br>
                SWF、TS、VOB、WMV、WEBM type upload</div>
  ...
  <div slot="footer" class="dialog-footer">
    <el-button @click="dialogVideoFormVisible = false">Delete</el-button>
